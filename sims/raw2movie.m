function reel = raw2movie(basename, z_norm, decades)
  ...
  % The absolute value of the data is used together with logarithmic scaling. 

  % The user may specify one, two, or three arguments.
  ...
  % data is assumed to vary between 1.0 and 10ˆ(-decades)
  ...
  while fid != -1
    ...
    data = flipud(transpose(reshape(fread(fid, size_x*size_y, 'single'), size_x, size_y)));
